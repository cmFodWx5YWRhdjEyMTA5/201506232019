...
/*        if (id == R.id.action_settings) {
        ...
        if (id == R.id.nav_dashboard) {
            if (!strUserType.isEmpty()) {
                ...
                if (strUserType.equalsIgnoreCase("PASSENGER")) {
                    it = new Intent(HelpSupport.this, DashboardPass.class);
                    startActivity(it);
                } else {
                    it = new Intent(HelpSupport.this, DashboardDriver.class);
                    startActivity(it);
                }
            }
        } else if (id == R.id.nav_add_funds) {
            Intent it = new Intent(HelpSupport.this, AddFunds.class);
            startActivity(it);
        } else if (id == R.id.nav_register_route1) {
            Intent it = new Intent(HelpSupport.this, RegisterRoute1.class);
            startActivity(it);
        } else if (id == R.id.nav_register_route2) {
            Intent it = new Intent(HelpSupport.this, RegisterRoute2.class);
            startActivity(it);
        } else if (id == R.id.nav_history) {
            Intent it = new Intent(HelpSupport.this, TransactionHistory.class);
            startActivity(it);
        } else if (id == R.id.nav_help) {
            Intent it = new Intent(HelpSupport.this, HelpSupport.class);
            startActivity(it);
        } else if (id == R.id.nav_start_ride) {
            Intent it = new Intent(HelpSupport.this, StartRide.class);
            startActivity(it);
    ...
    private void logoutUser() {
        ...
        editor.clear().commit();
        editor.apply();
        Intent itLogout = new Intent(HelpSupport.this, signin.class);
