...
public class DashboardDriver extends AppCompatActivity
    ...
    private static final String TAG = "DASHBOARD_DIVER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageRoute1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(DashboardDriver.this, RegisterRoute1.class);
                startActivity(it);
            }
        });
        ...
        imageRoute2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(DashboardDriver.this, RegisterRoute2.class);
                startActivity(it);
            }
        });
        ...
        imgHelpSupport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(DashboardDriver.this, HelpSupport.class);
                startActivity(it);
            }
        });
        ...
        imgTransactionHistory.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(DashboardDriver.this, TransactionHistory.class);
                startActivity(it);
            }
        });
...
/*        if (id == R.id.action_settings) {
        ...
        if (id == R.id.nav_dashboard) {
            if (!strUserType.isEmpty()) {
                ...
                if (strUserType.equalsIgnoreCase("PASSENGER")) {
                    it = new Intent(DashboardDriver.this, DashboardPass.class);
                    startActivity(it);
                } else {
                    it = new Intent(DashboardDriver.this, DashboardDriver.class);
                    startActivity(it);
                }
            }
    ...
    private void logoutUser() {
        ...
        editor.clear().commit();
        editor.apply();
        Intent itLogout = new Intent(DashboardDriver.this, signin.class);
